...
from evolution.core.lm_factory import create_lm
...
@click.option("--optimizer-model", default="hermes/gpt-5.4", help="Model for GEPA reflections")
@click.option("--eval-model", default="hermes/gpt-5.4", help="Model for evaluations")
